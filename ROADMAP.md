...
- ✅ Show connection quality in the panel label: ● Direct / ◐ Relayed / grey for no session.
...
- ✅ Add a `make deb` GitHub Actions job so the `.deb` is always built on Linux and attached to releases.
